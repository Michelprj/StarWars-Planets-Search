...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-035-project-starwars-planets-search-ts.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-035-project-starwars-planets-search-ts`
  ...
  - Agora, crie uma branch à qual você vai submeter os `commits` de seu projeto.
    ...
    - Exemplo: `git checkout -b joaozinho-sd-035-project-starwars-planets-search-ts`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-035-project-starwars-planets-search-ts`

  6. Crie um novo Pull Request (PR)

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-035-project-starwars-planets-search-ts/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-035-project-starwars-planets-search-ts/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH35&template=betrybe/sd-035-project-starwars-planets-search-ts)
